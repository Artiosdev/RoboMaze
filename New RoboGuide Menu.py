...
class PygView():
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if self._playButton.pressed(pygame.mouse.get_pos()): 
                        self._width=1258                                                                     # new width for the screen
                        self._height= 818                                                                    # new height for the screen
                        ...
                        self._screen.blit(self._maze1,(0,0))                                                 # apply the changes with maze to the screen
                        pygame.display.flip()
    ...
    def draw_text(self, text, x, y):
        ...
        surface = self._font.render(text, True, (0, 0, 255))
    ...
    def SetUpImage(self) :
        ...
        self._maze1=pygame.image.load('Concept_Art3.png') # Same as above
        self._maze1=pygame.transform.scale(self._maze1,(1258,818))
