            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.QUIT:
                    ...
                    if self._backButton.pressed(pygame.mouse.get_pos()):
                        ...
                        self._backButton.create_button(self._screen,(173,216,230),0,0,100,25,6,'Back',(0,0,0))
                        if self._backButton.pressed(pygame.mouse.get_pos()):
                            PygView.run(self)
...
"""
        ...
        self._menu=pygame.transform.scale(self._menu,(900,400)) # change the size of the image in terms of height and width
